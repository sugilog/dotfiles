...
BREWS := wget the_silver_searcher awscli amazon-ecs-cli colordiff lua reattach-to-user-namespace tmux heroku zstd
CASKS := macvim rstudio postman google-cloud-sdk drawio jadengeller-helium
