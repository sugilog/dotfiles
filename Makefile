...
CASKS := postman session-manager-plugin google-cloud-sdk drawio kindle alfred 1password karabiner-elements google-japanese-ime docker appcleaner mysqlworkbench firefox homebrew/cask-versions/google-chrome-beta slack tunnelblick
